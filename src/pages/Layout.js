    ...
    <footer className="footer">
      <Container>
        ...
        <div className="footer__list">
          <a href="https://vk.com"><img className="footer__media" src="/img/vk.png" alt="vk" /></a>
          <a href="https://web.telegram.org"><img className="footer__media" src="/img/tg.png" alt="tg" /></a>
          <a><img className="footer__media" src="/img/email.png" alt="email" /></a>
          <a><img className="footer__media" src="/img/phone.png" alt="phone" /></a>
        </div>
      </Container>
    </footer>
  )
